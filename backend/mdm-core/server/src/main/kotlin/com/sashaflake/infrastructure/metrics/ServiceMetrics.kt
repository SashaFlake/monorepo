...
class ServiceMetrics {
    ...
    fun init(registry: MeterRegistry) {
        createAttempts = Counter.builder("mdm_core_create_attempts_total").register(registry)
        createSuccess = Counter.builder("mdm_core_create_success_total").register(registry)
        createFailure = Counter.builder("mdm_core_create_failure_total").register(registry)
        createTimer = Timer.builder("mdm_core_create_duration_seconds").register(registry)
    }
