...
class ServiceMetrics {
    ...
    fun init(registry: MeterRegistry) {
        createAttempts = Counter.builder("bff_create_attempts_total").register(registry)
        createSuccess = Counter.builder("bff_create_success_total").register(registry)
        createFailure = Counter.builder("bff_create_failure_total").register(registry)
        createTimer = Timer.builder("bff_create_duration_seconds").register(registry)
    }
