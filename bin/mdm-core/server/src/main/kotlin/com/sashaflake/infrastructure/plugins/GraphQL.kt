...
import com.sashaflake.presentation.graphql.ExampleMutation
...
fun Application.configureGraphQL() {
    val exampleMutation by inject<ExampleMutation>()
    ...
    install(GraphQL) {
        schema {
            ...
            mutations = listOf(exampleMutation)
            // TODO: добавить остальные queries/mutations
        }
        server {
