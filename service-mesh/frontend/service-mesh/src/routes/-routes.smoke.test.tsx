...
describe('route smoke tests', () => {
  it('index route renders dashboard', async () => {
    ...
    const Comp = (Route as unknown as { component: React.ComponentType }).component
    render(<Comp />)
  ...
  it('services.$serviceId route renders service detail', async () => {
    ...
    const route = Route as unknown as { component: React.ComponentType; useParams: () => { serviceId: string } }
